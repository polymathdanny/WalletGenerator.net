module.exports = (async function () {
  ...
  const Ripple = await import("./coins/ripple");
  const IOTA = await import("./coins/iota");
  ...
  let currencies = [
    ...
    new Bitcoin("BitcoinCandy", 0x1c, 0x80, ""),
    ...
    // Any PRs that uncomment below line will be rejected regardless of its reason.
    // See #14 and COINS_WILL_NOT_BE_ADDED.md.
    //new Bitcoin("CPUchain", 0x1c, 0x80, "", 0x1e, "cpu"),
    ...
    new ZcashT("Koto", 0x1836, 0x80, "k12Ygmfi3fZVYr78ETiXNyb4vETdYY3Q2s9"),
    new ZcashZ("Koto Private Address", [0xab, 0x36], [0xa8, 0xab, 0xd3], [0x16, 0xa8], "k12Ygmfi3fZVYr78ETiXNyb4vETdYY3Q2s9"),
    ...
    new Bitcoin("Sato", 0x3f, 0x80, "SkKrWypwzKKjrvzYrYFUcEhxKYWQQHGpGd"),
    ...
    new ZcashT("Zcash", 0x1cb8, 0x80, "t1b4enxoohBEVWpdZNNWLDLqSMmRgm5tRUb"),
    new ZcashZ("Zcash Private Address", [0xab, 0x36], [0xa8, 0xab, 0xd3], [0x16, 0x9a], "t1b4enxoohBEVWpdZNNWLDLqSMmRgm5tRUb"),
  ...
  Object.defineProperty(result, "selectedCurrency", {
